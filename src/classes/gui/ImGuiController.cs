...
/**
 * Code inspired by https://github.com/NogginBops/ImGui.NET_OpenTK_Sample
 */
...
void main()
{
    outputColor = color * texture(in_fontTexture, texCoord);
        ...
        private void UpdateImGuiInput(GameWindow wnd)
        {
            ...
            var screenPoint = new Vector2i((int)MouseState.X * retinaScale, (int)MouseState.Y * retinaScale);
